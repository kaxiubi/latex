...
\section{背景}
2023年10月本科部修订了《中国科学院大学本科生毕业论文（设计）撰写规范指导意见》（以下简称《指导意见》）。为方便各位同学使用，特提供此模板。
...
\begin{table}
    \bicaption{\enspace 支持的LaTeX编译系统和编辑器支持的LaTeX编译系统和编辑器支持的LaTeX编译系统和编辑器}{\enspace Supported LaTeX compiler and editor}% caption
